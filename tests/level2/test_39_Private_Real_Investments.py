...
from src.level2.alternative_investments import *
import pandas as pd




# Testing CFA II 2020 Reading 39 :Private Real Estate Investments on curriculum examples
print('Hello')
...
class TestAssociates(unittest.TestCase):
    def test_private_real_estate(self):
        # Example 1.1
        ...
        associate = private_real_estate_investments.PrivateRealEstate(name='Branch', interest=ts_interest,
